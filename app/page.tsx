      ...
      <main className="main-content">
        ...
        <section id="how-to-get-points" style={{ width: "100%", marginTop: "4rem", scrollMarginTop: "20vh" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1.5rem", maxWidth: "800px", margin: "0 auto" }}>
            <div className="glass-panel tutorial-card-horizontal activity">
              <div className="tutorial-icon-wrapper">
                <Tv size={36} color="var(--accent-secondary)" />
              </div>
              <div className="tutorial-text-wrapper">
                <h3>Aktivita v chatu</h3>
                <p>Piš do chatu na streamu a získávej <strong>5 bodů každých 5 minut</strong>. Napiš <strong>!points</strong> pro zjištění bodů.</p>
              </div>
            </div>
            
            <div className="glass-panel tutorial-card-horizontal sub">
              <div className="tutorial-icon-wrapper" style={{ borderColor: "rgba(255, 215, 0, 0.2)", background: "rgba(255, 215, 0, 0.05)" }}>
                <Crown size={36} color="#FFD700" />
              </div>
              <div className="tutorial-text-wrapper">
                <h3>Aktivní Sub</h3>
                <p>Subové získávají <strong>10 bodů / 5 min</strong> za aktivitu v chatu + <strong>500 bodů</strong> za sub!</p>
              </div>
            </div>
            
            <div className="glass-panel tutorial-card-horizontal gift">
              <div className="tutorial-icon-wrapper" style={{ borderColor: "rgba(76, 175, 80, 0.2)", background: "rgba(76, 175, 80, 0.05)" }}>
                <Gift size={36} color="#4CAF50" />
              </div>
              <div className="tutorial-text-wrapper">
                <h3>Darování Suba</h3>
                <p>Za darování suba získáš okamžitě <strong>500 bodů</strong>.</p>
              </div>
            </div>
            
            <div className="glass-panel tutorial-card-horizontal kicks">
              <div className="tutorial-icon-wrapper" style={{ borderColor: "rgba(0, 229, 255, 0.2)", background: "rgba(0, 229, 255, 0.05)" }}>
                <Zap size={36} color="#00e5ff" />
              </div>
              <div className="tutorial-text-wrapper">
                <h3>Darování Kicks</h3>
                <p>Za každých <strong>100 Kicks</strong> získáš <strong>100 bodů</strong>.</p>
              </div>
            </div>
          </div>
        </section>
