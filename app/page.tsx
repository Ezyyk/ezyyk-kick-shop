  ...
  return (
    <div className="container">
      ...
      <main className="main-content">
        ...
        <section id="how-to-get-points" style={{ width: "100%", marginTop: "4rem", scrollMarginTop: "20vh" }}>
          <h2 style={{ marginBottom: "2.5rem", display: "flex", alignItems: "center", gap: "0.8rem", justifyContent: "center", fontSize: "2.5rem" }}>
            <Info size={32} color="var(--accent-primary)" /> Jak získávat body?
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "2rem", maxWidth: "900px", margin: "0 auto" }}>
            <div className="glass-panel tutorial-card activity">
              <div style={{ background: "rgba(138, 43, 226, 0.15)", padding: "1.2rem", borderRadius: "50%", border: "1px solid rgba(138, 43, 226, 0.3)" }}>
                <Tv size={40} color="var(--accent-secondary)" />
              </div>
              <h3 style={{ margin: 0, fontSize: "1.4rem" }}>Aktivita v chatu</h3>
              <p style={{ margin: 0, color: "var(--text-secondary)", fontSize: "1.05rem", lineHeight: 1.5 }}>Piš do chatu na streamu a získávej <strong style={{ color: "var(--text-primary)" }}>5 bodů každých 5 minut</strong>. Napiš <strong style={{ color: "var(--accent-primary)" }}>!points</strong> pro zjištění bodů.</p>
            </div>
            
            <div className="glass-panel tutorial-card sub">
              <div style={{ background: "rgba(255, 215, 0, 0.1)", padding: "1.2rem", borderRadius: "50%", border: "1px solid rgba(255, 215, 0, 0.2)" }}>
                <Crown size={40} color="#FFD700" />
              </div>
              <h3 style={{ margin: 0, fontSize: "1.4rem" }}>Aktivní Sub</h3>
              <p style={{ margin: 0, color: "var(--text-secondary)", fontSize: "1.05rem", lineHeight: 1.5 }}>Subové získávají <strong style={{ color: "var(--text-primary)" }}>10 bodů / 5 min</strong> za aktivitu v chatu + <strong style={{ color: "var(--text-primary)" }}>500 bodů</strong> za sub!</p>
            </div>
            
            <div className="glass-panel tutorial-card gift">
              <div style={{ background: "rgba(76, 175, 80, 0.1)", padding: "1.2rem", borderRadius: "50%", border: "1px solid rgba(76, 175, 80, 0.2)" }}>
                <Gift size={40} color="#4CAF50" />
              </div>
              <h3 style={{ margin: 0, fontSize: "1.4rem" }}>Darování Suba</h3>
              <p style={{ margin: 0, color: "var(--text-secondary)", fontSize: "1.05rem", lineHeight: 1.5 }}>Za darování suba získáš okamžitě <strong style={{ color: "var(--text-primary)" }}>500 bodů</strong>.</p>
            </div>
            
            <div className="glass-panel tutorial-card kicks">
              <div style={{ background: "rgba(0, 229, 255, 0.1)", padding: "1.2rem", borderRadius: "50%", border: "1px solid rgba(0, 229, 255, 0.2)" }}>
                <Zap size={40} color="#00e5ff" />
              </div>
              <h3 style={{ margin: 0, fontSize: "1.4rem" }}>Darování Kicks</h3>
              <p style={{ margin: 0, color: "var(--text-secondary)", fontSize: "1.05rem", lineHeight: 1.5 }}>Za každých <strong style={{ color: "var(--text-primary)" }}>100 Kicks</strong> získáš <strong style={{ color: "var(--text-primary)" }}>100 bodů</strong>.</p>
            </div>
          </div>
        </section>
